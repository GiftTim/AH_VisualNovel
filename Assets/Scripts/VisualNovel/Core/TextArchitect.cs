...
public class TextArchitect
{
    ...
    private void Prepare_Fade()
    {
        ...
        Color colorVisiable = new Color(tmpro.color.r, tmpro.color.g, tmpro.color.b, 1);
        Color colorInvisible = new Color(tmpro.color.r, tmpro.color.g, tmpro.color.b, 0);
        ...
        for(int i = 0; i < textInfo.characterCount; i++)
        {
            ...
            {
                for (int v = 0; v < 4; v++)
                    vertexColors[charInfo.vertexIndex + v] = colorVisiable;
            }
            else
            {
                for (int v = 0; v < 4; v++)
