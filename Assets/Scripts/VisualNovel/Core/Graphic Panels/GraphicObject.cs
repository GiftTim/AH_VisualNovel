...
public class GraphicObject
{
    ...
    private Material GetTransitionMaterial()
    {
        ...
        {
            Debug.LogError($"Could not load transition material from path '{MATERIAL_PATH}'. Please ensure it exists within Resources!");
            return null;
        }
    }
