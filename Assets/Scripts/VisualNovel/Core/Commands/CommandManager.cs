    ...
    public class CommandManager : MonoBehaviour
    {
        ...
        private CoroutineWrapper ExecuteSubCommand(string commandName, string[] args)
        {
            ...
            if(subDatabases.ContainsKey(databaseName))
            {
                ...
                {
                    Debug.LogError($"No command called '{subCommandName}' was found in the sub-database '{databaseName}'");
                    return null;
                }
            ...
            Debug.LogError($"No sub-database called '{databaseName}' exists! '{subCommandName}' could not be run.");
            return null;
        ...
        private CoroutineWrapper ExecuteCharacterCommand(string commandName, params string[] args)
        {
            ...
            Debug.LogError($"Command Manager was unable to execute command '{commandName}' on character '{args[0]}'. the character name or may be invalid.");
            return null;
        }
