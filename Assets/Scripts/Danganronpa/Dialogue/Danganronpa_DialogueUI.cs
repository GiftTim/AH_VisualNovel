...
public class Danganronpa_DialogueUI : MonoBehaviour
{
    [Header("Danganronpa_Dialogue UI 요소")]
    ...
    [Header("Danganronpa_DialogueTextPrinter (대사 출력기)")]
    private Danganronpa_DialogueTextPrinter printer;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("Danganronpa_DialogueUI: 필수 UI 요소가 할당되지 않았습니다.");
            return;
        }

        printer = new Danganronpa_DialogueTextPrinter();
    }
